...
public class Ordem_ServicoDao {
    ...
    public static final String SQL_PESQUISAR = "SELECT ID_ORDEMSERVICO, SERVICO, ESTADOEQUIPAMENTO, FROM ORDEMSERVICO JOIN SERVICO ON ORDEMSERVICO.ID_ORDEMSERVICO = ORDEMSERVICO.ID_ORDEMSERVICO ORDER BY EQUIPAMENTO";
