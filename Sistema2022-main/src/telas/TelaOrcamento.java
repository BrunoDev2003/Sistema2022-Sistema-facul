...
public class TelaOrcamento extends TelaCadastro {
    private MeuCampoTexto mctEquipamento= new MeuCampoTexto("Equipamento", 5, true);
    ...
    public TelaOrcamento() {
        super("Orçamento");
        setVisible(true);
        adicionaCampo(mctEquipamento, 1, 2, 1, 1);
        adicionaCampo(mctMarca, 2, 2, 1, 3);
        adicionaCampo(mctProduto, 1, 4, 1, 1);
